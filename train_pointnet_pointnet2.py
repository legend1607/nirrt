...
def main(args):
    ...
    env_type = args.env+str(args.dim)+'d'
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for i, batch in tqdm(enumerate(trainDataLoader), total=len(trainDataLoader), smoothing=0.9):
            ...
            pc_xyz = torch.Tensor(point_utils.rotate_point_cloud_z(pc_xyz.data.numpy()))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='random', choices=['random', 'kuka'])
